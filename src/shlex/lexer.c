...
static int lexer_lex_untyped(struct token *token,
...
enum lexer_op sublexer_exp_subsh_open(
    struct lexer *lexer, struct wlexer *wlexer,
    struct token *token, struct wtoken *wtoken) {
    wtoken_push(token, wtoken);
...
enum lexer_op sublexer_exp_subsh_close(
    struct lexer *lexer __unused, struct wlexer *wlexer,
    struct token *token, struct wtoken *wtoken) {
    wtoken_push(token, wtoken);
...
enum lexer_op sublexer_subsh_open(
    struct lexer *lexer, struct wlexer *wlexer,
    struct token *token, struct wtoken *wtoken) {
    wtoken_push(token, wtoken);
...
enum lexer_op sublexer_subsh_close(
    struct lexer *lexer __unused, struct wlexer *wlexer,
    struct token *token, struct wtoken *wtoken) {
    wtoken_push(token, wtoken);
...
enum lexer_op sublexer_arith_open(
    struct lexer *lexer, struct wlexer *wlexer,
    struct token *token, struct wtoken *wtoken) {
    wtoken_push(token, wtoken);
...
enum lexer_op sublexer_arith_close(
    struct lexer *lexer __unused, struct wlexer *wlexer,
    struct token *token, struct wtoken *wtoken) {
    wtoken_push(token, wtoken);
...
enum lexer_op sublexer_exp_open(
    struct lexer *lexer, struct wlexer *wlexer,
    struct token *token, struct wtoken *wtoken) {
    wtoken_push(token, wtoken);
...
enum lexer_op sublexer_exp_close(
    struct lexer *lexer __unused, struct wlexer *wlexer,
    struct token *token, struct wtoken *wtoken) {
    wtoken_push(token, wtoken);
...
static int lexer_lex_untyped(struct token *token,
    ...
    while (true) {
        ...
        enum lexer_op op = sublexers[wtoken.type](
            lexer, wlexer, token, &wtoken);
