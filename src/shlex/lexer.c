...
static enum lexer_op sublexer_eof(struct lexer *lexer __unused,
...
static enum lexer_op sublexer_btick(struct lexer *lexer __unused,
                                    struct wlexer *wlexer, struct token *token,
                                    struct wtoken *wtok) {
  bool escape = false;
...
static enum lexer_op sublexer_escape(struct lexer *lexer __unused,
                                     struct wlexer *wlexer, struct token *token,
                                     struct wtoken *wtoken __unused) {
...
static enum lexer_op sublexer_exp_subsh_open(struct lexer *lexer,
...
static enum lexer_op sublexer_subsh_open(struct lexer *lexer,
                                         struct wlexer *wlexer,
                                         struct token *token,
                                         struct wtoken *wtoken) {
  wtoken_push(token, wtoken);
...
static enum lexer_op sublexer_arith_open(struct lexer *lexer,
                                         struct wlexer *wlexer,
                                         struct token *token,
                                         struct wtoken *wtoken) {
  wtoken_push(token, wtoken);
...
static enum lexer_op sublexer_exp_open(struct lexer *lexer,
                                       struct wlexer *wlexer,
                                       struct token *token,
                                       struct wtoken *wtoken) {
  wtoken_push(token, wtoken);
